...
export default function WhatsAppSettingsPanel({
  ...
  clientId: string
  // A client admin gets this section for the wallet only; the Meta
  // credentials and the test send belong to the agency.
  role?: string
}) {
  const canEditConfig = canEditWhatsAppConfig(role)
  // Config form state
