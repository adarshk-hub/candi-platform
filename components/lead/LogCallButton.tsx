// path: components/lead/LogCallButton.tsx
'use client'
  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 rounded-md border border-border px-3 py-1.5 text-sm text-muted2 hover:border-green-500 hover:text-fg"
      >
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-sm rounded-card border border-border bg-card p-5">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={() => setOpen(false)} className="text-muted2 hover:text-fg">
                <X size={18} />
              </button>
            </div>
